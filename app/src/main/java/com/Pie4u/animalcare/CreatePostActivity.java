                                     ...
                                     storageReference.child(key).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            db.collection("ProfileData")
                                                    .document(blogUser.getUid()).get()
                                                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                        @Override
                                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                            if (documentSnapshot.exists() && documentSnapshot.get("name") != null) {
                                                                String name = documentSnapshot.get("name").toString();
                                                                BlogData myBlogData = new BlogData(name, formattedDate, blogDescr, blogUser.getUid());
                                            ...
                                            BlogData myBlogData = new BlogData(blogUser.getDisplayName(),formattedDate,blogDescr,blogUser.getUid());
                                            myBlogData.setImageURL(imageUrl);
                                            myBlogData.setPostKey(key);
